...
public class StockConverter {
    ...
    public Stock convert(StockDto stockDto) {
        ...
        stock.setBackupQuantity(stockDto.getBackupQuantity());
    ...
    public StockDto convert(Stock stock) {
        ...
        stockDto.setBackupQuantity(stock.getBackupQuantity());
    ...
    public Stock convert(Stock existingStock,StockDto newStock){
        ...
        existingStock.setBackupQuantity(newStock.getBackupQuantity());
